...
export default defineWebSocketHandler({
  open(peer) {
    ...
    // Store the peer object directly - it has a send method
    connections.set(playerId, peer)
    console.log('(Server) WebSocket connection opened:', playerId)
  },
  
  message(peer, message) {
    handleMessage(peer, peer.playerId, message.text())
  },
  
  close(peer) {
    console.log('(Server) WebSocket connection closed:', peer.playerId)
    if (peer.playerId) {
      cleanupPlayer(peer.playerId)
    }
  },
